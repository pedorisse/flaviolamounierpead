...
const projects: P[] = [
  { n: "01", title: "Subadutora Cubatão", loc: "Santos / Cubatão · SP", img: sao, video: cubataoVideo.url, demoVimeoId: "1211900787",
    ...
    body: "Projeto acompanhado por Flávio Lamounier, executado com MND (Método Não Destrutivo), utilizando tubulações lisas em PEAD azul instaladas sob o leito do mar e do Canal do Porto de Santos, sem intervenções destrutivas nas vias urbanas. A solução amplia a estabilidade e a segurança hídrica para quase meio milhão de moradores e turistas da região. Operação que envolveu 100% da tubulação do trecho, com mais de 5.000 metros lineares e mais de 100 carretas entregues em tempo recorde, garantindo agilidade logística e suporte a uma obra estratégica para o abastecimento regional.",
    tags: ["PEAD", "MND", "Travessia Subaquática", "Segurança Hídrica"] },
  { n: "02", title: "Sistema Integrado do Litoral Norte", loc: "Litoral Norte · SP", img: sao, video: litoralVideo.url, demoVimeoId: "1212678874",
    headline: "Ampliação e segurança hídrica para os municípios do Litoral Norte de São Paulo.",
    body: "Projeto acompanhado por Flávio Lamounier, voltado à ampliação, modernização e garantia da segurança do sistema de abastecimento de água dos municípios do Litoral Norte de São Paulo. A solução foi desenvolvida para reduzir os riscos de desabastecimento provocados pelo crescimento populacional e pelo aumento expressivo da demanda durante as temporadas de turismo. Participação em uma operação que envolveu centenas de carretas para a modernização dos sistemas de água e esgoto, contribuindo para ampliar a capacidade operacional, a confiabilidade da rede e a segurança hídrica para moradores e visitantes.",
