...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:site_name", content: "Flávio Lamounier" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Flávio Lamounier | Infraestrutura Hídrica e Soluções em PEAD" },
      { name: "twitter:description", content: "Portfólio técnico de Flávio Lamounier, com atuação em infraestrutura hídrica, saneamento, tubulações PEAD e grandes projetos de água e esgoto." },
    ],
    links: [
      {
        rel: "stylesheet",
